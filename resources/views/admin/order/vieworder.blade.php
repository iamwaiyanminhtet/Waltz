...
<body class="bg-dark">
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr class="border border-dark">
                                    <th class="border border-dark p-2">Image</th>
                                    ...
                                    <th class="border border-dark p-2">Total Price</th>
                                    <th class="border border-dark p-2">OrderCode</th>
                                    <th class="border border-dark p-2">Date</th>
                                </tr>
                            </thead>
                            <tbody class="table-border-bottom-0">
                                ...
                                <tr class="table-primary border border-dark">
                                    ...
                                    <td class="border border-dark p-2">{{ $orderItem->product_name }}</td>
                                    <td class="border border-dark p-2">{{ $orderItem->product_price }}</td>
                                    <td class="border border-dark p-2">{{ $orderItem->quantity }}</td>
                                    <td class="border border-dark p-2">{{ $orderItem->total_price }}</td>
                                    <td class="border border-dark p-2">{{ $orderItem->order_code }}</td>
                                    <td class="border border-dark p-2">{{ $orderItem->created_at->format('d-m-Y') }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
          ...
          <h3 class="text-dark text-center">Thanks For Shopping with us. Have a nice day!</h3>
        </div>
        <!-- / Content -->
